...
import { MenuCloseIcon, SharkIcon, ShrimpIcon, WhaleIcon } from "../svgIcons";
...
export default function MobileSidebar() {
  ...
  return (
    <div
      className="w-[280px] border-r border-gray-700 block lg:hidden fixed left-0 top-0 h-screen z-[1000] bg-gray-900 shadow-2xl duration-200 font-sans"
      style={{
    ...
    >
      <div className="px-3 flex items-center justify-between">
        ...
        <button className="w-6 h-6" onClick={closeSidebar}>
          <MenuCloseIcon fill="#ffffff90" />
        </button>
      </div>
